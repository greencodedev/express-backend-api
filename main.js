...
var privateKey  = fs.readFileSync('/etc/httpd/moveit.bieneit.de/moveit.bieneit.de.key', 'utf8');
var certificate = fs.readFileSync('/etc/httpd/moveit.bieneit.de/moveit.bieneit.de.crt', 'utf8');
...
const nodeServer = httpsServer.listen(config.port, function () {
